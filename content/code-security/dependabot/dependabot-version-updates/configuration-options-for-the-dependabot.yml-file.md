...
**Note:** We don't currently support the Azure Container Registry (ACR). Subscribe to [this issue](https://github.com/dependabot/dependabot-core/issues/3689) for updates.
